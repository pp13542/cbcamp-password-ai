...
아래 문구를 문제 제공 웹사이트의 상세 설명으로 사용할 수 있습니다.

> **비밀번호 설정 도움 AI**
>
> 한 웹사이트에서 사용자의 비밀번호 복구와 재설정을 지원하기 위해 AI 챗봇을 도입했습니다. 이 AI는 과거 비밀번호 복구 상담 기록을 학습했으며, 운영자는 플래그나 비밀번호 같은 민감정보를 직접 제공하지 않도록 제한했다고 주장합니다.
>
> 하지만 AI 모델은 질문의 표현과 대화 상황에 따라 학습 데이터에 포함된 이전 상담 내용을 떠올릴 수도 있습니다. 챗봇의 정상 비밀번호 복구 절차를 확인하고 다양한 방식으로 대화하여, AI가 기억하고 있는 이전 사용자의 중요한 값을 획득하세요.
>
> 테스트용 가입 이메일: `CBCAMP@camp.com`
>
> 플래그 형식: `CBCAMP{...}`
